...
REM
REM Generated by Vivado on Sun Mar 15 15:45:33 -0400 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_fc_layer_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_fc_layer_vlog.prj -log xvlog.log
