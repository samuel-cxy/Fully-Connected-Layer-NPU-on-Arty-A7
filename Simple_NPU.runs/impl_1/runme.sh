...
HD_PWD='C:/Users/samue/Documents/Arty-7-100T/Simple_NPU/Simple_NPU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log npu_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source npu_top.tcl -notrace
