...
HD_PWD='C:/Users/samue/Documents/Arty-7-100T/Simple_NPU/Simple_NPU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log npu_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source npu_top.tcl
